...
# Introduction
---
This is the capstone project for LITA Workshopto showcase my data analysis expertise developed in data analytics workshop of 3-months learning using microsoft excel, sql and powerbi.


## Problem Statement
---

 and areas for improvemesales performance across different regionsnt for revenue generation, strategic decision-making, performance evaluation
